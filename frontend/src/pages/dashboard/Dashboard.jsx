...
function GrafikTooltip({ active, payload, label }) {
    ...
    return (
        <div className="ss-chart-tooltip px-4 py-3 text-sm min-w-[160px]">
            <p className="font-bold ss-ink mb-2 pb-1.5 border-b border-[var(--panel-line)]">{label}</p>
...
export default function Dashboard() {
    ...
    useEffect(() => {
        Promise.allSettled([
            axios.get("/analitik/dashboard"),
            axios.get("/urunler/kritik"),
    ...
    if (yukleniyor) return <PageLoader label="Genel bakış yükleniyor…" />
    ...
    if (!veri) return (
        <div className="flex flex-col items-center justify-center h-[60vh] gap-4">
            ...
            <div className="text-center">
                ...
                <p className="text-sm text-gray-400 mt-1">Bağlantı kurulamadı. Biraz sonra tekrar deneyin.</p>
            </div>
    ...
    const kategoriler = veri.kategori_dagilimi || []
    const grafik = veri.son_30_gun_grafik || []
    const maxKat = kategoriler[0]?.stok_degeri || 1
    const bosHesap = (veri.toplam_urun ?? 0) === 0

    if (bosHesap) {
        return (
            <div className="space-y-6">
                <div className="ss-card ss-card--hover px-8 py-6">
                    <h1 className="text-2xl font-bold text-gray-800 dark:text-gray-100">
                        {selamlama()}, {kullanici?.ad?.split(" ")[0] || "Kullanıcı"} 👋
                    </h1>
                    <p className="text-sm text-gray-400 mt-1">{bugunTarih()}</p>
                </div>
                <EmptyState
                    icon="📦"
                    title="Henüz veri yok"
                    description="İlk ürününüzü ekleyerek stok yönetimine başlayın. Özet kartlar ve grafikler ürün ekledikçe dolacak."
    ...
    return (
        <div className="space-y-6">
            ...
            {/* ── Hoşgeldin Şeridi ────────────────────────────────────────── */}
            <div className="ss-card ss-card--hover px-8 py-6 flex items-center justify-between">
                <div className="flex items-center gap-5">
                    <Logo variant="icon" size="lg" theme="dark" decorative className="shrink-0" />
                    <div>
                        <p className="text-xs text-gray-400 font-medium mb-0.5">{bugunTarih()}</p>
                        <h1 className="text-2xl font-bold ss-ink ss-metric">
                            {selamlama()}, {kullanici?.ad?.split(" ")[0] || "Kullanıcı"} 👋
                        </h1>
            ...
            <div className="grid grid-cols-5 gap-4">
                ...
                <div className="ss-card ss-card--hover p-5">
                    <div className="flex items-center justify-between mb-3">
                        <p className="ss-label">Toplam Ürün</p>
                        <div className="w-8 h-8 bg-blue-50 dark:bg-blue-900/30 rounded-lg flex items-center justify-center">
                            <Package size={15} className="text-blue-600" />
                        </div>
                    </div>
                    <p className="text-3xl font-bold ss-ink ss-metric">
                        {(veri.toplam_urun ?? 0).toLocaleString("tr-TR")}
                    </p>
                ...
                <div className="ss-card ss-card--hover p-5">
                    <div className="flex items-center justify-between mb-3">
                        <p className="ss-label">Stok Değeri</p>
                ...
                <div className="ss-card ss-card--hover p-5">
                    <div className="flex items-center justify-between mb-3">
                        <p className="ss-label">Ort. Marj</p>
            ...
            <div className="grid grid-cols-5 gap-5">
                ...
                {/* Grafik — 3 kolon */}
                <div className="col-span-3 ss-card ss-card--hover p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div className="col-span-2 ss-card ss-card--hover p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                ...
                <div className="ss-card ss-card--hover p-6 shadow-sm border border-gray-100 dark:border-gray-700">
                    ...
                    <div className="space-y-2.5">
                        {[
                            ...
                            {
                                label: "Talep Tahmini",
                                desc:  "Gelecek satış ihtiyacını görün",
                                icon:  <Zap size={16} />,
                            ...
                            },
                            {
                                ...
                                desc:  "Ne kadar sipariş vereceğinizi hesaplayın",
                            ...
                            },
                            {
                                ...
                                desc:  "Ürün önceliği ve envanter raporları",
