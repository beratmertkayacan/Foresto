...
export default function Urunler() {
    ...
    // ── KPI hesapları ────────────────────────────────────────────────────────
    const kritikSayisi   = urunler.filter(u =>
        u.min_stok_seviyesi != null && u.mevcut_stok != null && u.mevcut_stok <= u.min_stok_seviyesi
    ).length
    ...
    const kaydet = async () => {
        ...
        try {
            if (duzenleMe) {
                await axios.put(`/urunler/${duzenleMe}`, payload)
                bildirimGoster("Ürün güncellendi")
            } else {
                await axios.post("/urunler/", payload)
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-end gap-6">
                <div>
                    <h1 className="text-2xl font-bold ss-ink ss-metric">Ürün Kataloğu</h1>
            ...
            <div className="grid grid-cols-4 gap-4">
                <div className="ss-card ss-card--hover p-5">
                    ...
                    <p className="text-2xl font-bold ss-ink ss-metric">{urunler.length.toLocaleString("tr-TR")}</p>
                    <p className="text-xs text-gray-400 mt-1">{kategoriler.length} kategori</p>
                </div>

                <div className="ss-card ss-card--hover p-5 shadow-sm border border-red-100 dark:border-red-900/30"
                ...
                <div className="ss-card ss-card--hover p-5">
                    <div className="flex items-center justify-between mb-3">
                        <p className="ss-label">Toplam Stok Değeri</p>
                ...
                <div className="ss-card ss-card--hover p-5">
                    <div className="flex items-center justify-between mb-3">
                        <p className="ss-label">Ort. Kâr Marjı</p>
            ...
            {!yukleniyor && urunler.length === 0 && (
                <EmptyState
                    ...
                    description="İlk ürününüzü ekleyerek stok takibine başlayın. Özet kartlar ve listeler burada görünecek."
            ...
            {/* Filtre Çubuğu + Tablo */}
            {(yukleniyor || urunler.length > 0) && <div className="-mx-8">
            ...
            <div className={`fixed top-16 right-0 h-[calc(100vh-4rem)] z-[65] transition-all duration-300
                ...
                <div ref={panelRef}
                    ...
                    <div ref={scrollRef} className="flex-1 overflow-y-auto px-7 py-6 space-y-5">
                        ...
                        {/* Ürün Adı */}
                        <div>
                            <label className="block ss-label mb-2">Ürün Adı *</label>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="block ss-label mb-2">Kategori</label>
                            ...
                            <div>
                                <label className="block ss-label mb-2">Birim</label>
                        ...
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                <label className="block ss-label mb-2">Maliyet Fiyatı (₺)</label>
                            ...
                            <div>
                                <label className="block ss-label mb-2">Satış Fiyatı (₺)</label>
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            <div>
                                <label className="block ss-label mb-2">Min Stok</label>
                            ...
                            <div>
                                <label className="block ss-label mb-2">Max Stok</label>
                            ...
                            <div>
                                <label className="block ss-label mb-2">Mevcut Stok</label>
